...
// ------------------------------------------------------------
//  Equivalent to Python:  step5_canonicalize.py
 ...
 * depending on the atom traversal order. Canonical SMILES is a unique,
 * standardized form — one SMILES per molecule.
 *
 * CDK provides SmilesGenerator.unique() which applies the Morgan/InChI
 * algorithm to produce a canonical ordering.
 *
 * This is essential in chemoinformatics because:
 *   - Database deduplication requires a unique key per structure
 *   - Machine learning models need consistent input representation
 *   - Substructure searches rely on canonical atom numbering
 *
 * RDKit equivalent: Chem.MolToSmiles(mol)
 * CDK equivalent  : SmilesGenerator.unique().create(mol)
 *
 * References:
 *   Weininger, D. (1988). SMILES. J. Chem. Inf. Comput. Sci., 28, 31-36.
...
public class Step4_Canonicalize {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  Isomeric SMILES encodes stereocenters (@ symbols).");
        System.out.println("  Canonical SMILES in CDK is non-isomeric by default.");
        System.out.println("  Use SmilesGenerator.isomeric() to preserve stereochemistry.\n");
        ...
        System.out.println("\n  KEY POINT: Two molecules are structurally identical if and");
        System.out.println("  only if their canonical SMILES strings are equal.");
        System.out.println("  This is how chemical databases detect duplicates.");
        System.out.println("============================================================");
    }
}
