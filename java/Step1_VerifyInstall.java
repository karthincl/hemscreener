...
// ------------------------------------------------------------
//  Equivalent to Python:  verify_install.py
//  Run in NetBeans: Right-click -> Run File (Shift+F6)
//  Requires: cdk-2.9.jar in the project lib/ folder
// ============================================================
...
/**
 * Step 1 — Verify that the CDK (Chemistry Development Kit) library
 * is correctly installed and accessible in the NetBeans project.
 *
 * CDK is the Java equivalent of RDKit (Python). It provides:
 ...
 *
 * Expected console output (NetBeans Output window):
 *   CDK version  : 2.9
 *   SMILES parse : OK — RDX parsed successfully (21 atoms)
 *   Atom count   : 21
 *   All CDK imports OK — environment is ready.
 *
 * CDK Reference:
 *   Willighagen, E. L. et al. (2017). The Chemistry Development Kit (CDK) v2.0.
 *   J. Cheminform., 9, 33. https://doi.org/10.1186/s13321-017-0220-4
 */
